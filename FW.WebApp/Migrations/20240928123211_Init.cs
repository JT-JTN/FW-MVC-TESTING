...
namespace FW.WebApp.Migrations
{
    /// <inheritdoc />
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppColors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_AppColors_Color",
                        column: x => x.Color,
                        principalTable: "AppColors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vehicles_Clients_Owner",
                        column: x => x.Owner,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppColors_Abbreviation",
                table: "AppColors",
                column: "Abbreviation",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppColors_Name",
                table: "AppColors",
                column: "Name",
                unique: true);
